            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('మన సినిమా. మన updates. ప్రతి రోజు.', textAlign: TextAlign.center, style: TfiTokens.telugu(17, color: TfiTokens.textMid)),
                  const SizedBox(height: 6),
                  Text('FREE · CONTENT-FIRST · TELUGU CINEMA', style: TfiTokens.body(11, color: TfiTokens.textFaint, w: FontWeight.w700)),
                ],
              ),
            ),
            Positioned(
